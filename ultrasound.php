...
<html class="no-js" lang="en">
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto small">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link active dropdown-toggle" href="departments.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Departments</a>
        ...
        <section id="ultrasound-banner" class="global">
            <div class="banner-position" id="dept_overlay">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h1 class="text-white display-3">Ultrasound Echocardiogram</h1>
                            <p class="text-white lead">Kind words can be short and easy to speak, but their echoes are truly endless.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container py-5 text-muted">
                <div class="row">
                    <div class="col-md-8 bg-white p-5">
                        <h4 class="pb-3">Expert Health Unit</h4>
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don’t look even slightly believable. If you are going to use a passage of lorem ipsum you need to be sure there isn’t anything embarrassing hidden in the middle of text.</p>
                        <p class="details_icon"><i class="fas fa-chevron-circle-right"></i>&nbsp;&nbsp;Proin libero tellus, ultrices eu vehicula sed</p>
                        <p class="details_icon"><i class="fas fa-chevron-circle-right"></i>&nbsp;&nbsp;Luctus vitae nulla. Quisque efficitur lobortis orci vehicula</p>
                        <p class="details_icon"><i class="fas fa-chevron-circle-right"></i>&nbsp;&nbsp;Sed tincidunt tincidunt velit, vel scelerisque nibh</p>
                        <p class="details_icon"><i class="fas fa-chevron-circle-right"></i>&nbsp;&nbsp;Suspendisse mi lorem, placerat in arcu ut, placerat aliquet</p>
                        <p class="details_icon"><i class="fas fa-chevron-circle-right"></i>&nbsp;&nbsp;Praesent bibendum felis nec turpis fringilla suscipit</p>
                        <h4 class="py-3">World Class Facilites</h4>
                    ...
                    <div class="col-md-4 bg-white pt-4">
                        <div class="row px-3">
                            <div class="col-md-12">
                                <h5 class="pt-3"><i class="fas fa-clipboard"></i></i>&nbsp;&nbsp;DEPARTMENT FIGURES</h5><hr class="hr-color">
                            </div>
                            <div class="col-md-9">
                                <p>RESIDENT DOCTORS</p>
                            </div>
                            <div class="col-md-3">
                                <p>17</p>
                            </div>
                        ...
                        <div class="row px-3">
                            <div class="col-md-12">
                                <h5 class="pt-3"><i class="fas fa-map-marker-alt icon-color"></i></i>&nbsp;&nbsp;LOCATE US</h5><hr class="hr-color">
                            </div>
                            <div class="col-md-12">
        ...
        <!-- Appointment Section -->
        <section id="departments-appointment">
            <div class="allign-middle">
                <div class="container py-5">
                    <div class="row text-center">
                        ...
                        <div class="col-md-6">
                            <a href="appointments.php" class="btn btn-info">Book An Appointment</a>
                        </div>
                    </div>
                </div>
            </div>
