...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <!-- Home Banner Section -->
        <section id="departments-banner" class="global">
            <div class="banner-position">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h1 class="text-white display-3">Medical <span>Departments</span></h1>
                            <p class="text-white lead">Kind words can be short and easy to speak, but their echoes are truly endless.</p>
                            <div class="text-center pb-4">
                                <a href="#" class="btn btn-info">Make An Appointment</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="overview">
            <div class="container py-5 text-muted">
                <div class="row text-center">
                    <div class="col-md-12">
                        <img src="assets/img/icon-2.png" class="img img-fluid">
                    </div>
                    <div class="col-md-12">
                        <h2>Striving To Cover All Your Medical Needs</h2>
            ...
            <div class="container py-5">
                <div class="row">
                    <div class="col-md-6 pb-4">
                        <div class="card">
                            <img src="assets/img/general-practice.jpg" class="card-img-top">
                            <div class="card-body p-5">
                                <div class="card-title">
                                    <h5>General Practice</h5><hr>
                                 </div>
                                <div class="card-text">
                                    <p>Expert Health Unit There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of lorem ipsum</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 pb-4">
                        <div class="card">
                            <img src="assets/img/cardiology.jpg" class="card-img-top">
                            <div class="card-body p-5">
                                <div class="card-title">
                                    <h5>Cardiology</h5><hr>
                                 </div>
                    ...
                    <div class="col-md-6 pb-4">
                        <div class="card">
                            <img src="assets/img/pediatrics.jpg" class="card-img-top">
                            <div class="card-body p-5">
                                <div class="card-title">
                                    <h5>Pediatrics</h5><hr>
                                 </div>
                    ...
                    <div class="col-md-6 pb-4">
                        <div class="card">
                            <img src="assets/img/diabetes-care.jpg" class="card-img-top">
                            <div class="card-body p-5">
                                <div class="card-title">
                                    <h5>Diabetes Care</h5><hr>
                                 </div>
                                <div class="card-text">
                                    <p>Expert Health Unit There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of lorem ipsum</p>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <img src="assets/img/pre-natel-care.jpg" class="card-img-top">
                            <div class="card-body p-5">
                                <div class="card-title">
                                    <h5>Pre-natal Care</h5><hr>
                                 </div>
                                <div class="card-text">
                                    <p>Expert Health Unit There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of lorem ipsum</p>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body p-5">
                                <div class="card-title">
                                    <h5>Ultrasound Echocardiogram</h5><hr>
                                 </div>
                                <div class="card-text">
                                    <p>Expert Health Unit There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of lorem ipsum</p>
                                </div>
